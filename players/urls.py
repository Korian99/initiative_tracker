...
urlpatterns = [
    ...
    path('load_lobby_edit_modal/<int:player_id>/', views.EditLobbyView.as_view(), name='load_lobby_edit_modal'),
    path('edit_lobby', views.EditLobbyView.as_view(), name='edit_lobby'),
    path('load_debuff_modal/<int:player_lobby_id>/<int:character_id>', views.DebuffView.as_view(), name='load_debuff_modal'),
    path('debuff_character', views.DebuffView.as_view(), name='debuff_character'),
    ...
    path('reload_current_turn/<int:player_id>/', views.TurnView.as_view(), name='reload_current_turn'),
